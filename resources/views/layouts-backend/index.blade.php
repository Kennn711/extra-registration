...
<head>
    ...
    <title>Extra Registration</title>
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.html"><img src="{{ asset('assets') }}/assets/compiled/svg/logo.svg" alt="Logo" srcset=""></a>
                        </div>
                ...
                @include('layouts-backend/partial/sidebar-backend')
            </div>
        </div>
        <div id="main">
            <header class="mb-3">
